...
class JHReqeust {
    ...
    @discardableResult
    public func setParameters(withDictinary parameter:Dictionary<String,String>) -> JHReqeust {
    ...
    @discardableResult
    public func setParameters(withKey key:String,value value:String) -> JHReqeust {
    ...
    @discardableResult
    public func setAuthorization(withValue authorization:String) -> JHReqeust {
    ...
    public func setHeader(withDictinary hearder:Dictionary<String,String>) -> JHReqeust {
    ...
    @discardableResult
    public func setHeader(withKey key:String,value value:String) -> JHReqeust {
    ...
    @discardableResult
    public func setBody(withDictinary body:Dictionary<String,String>) -> JHReqeust {
    ...
    @discardableResult
    public func setBody(withKey key:String,value value:String) -> JHReqeust {
